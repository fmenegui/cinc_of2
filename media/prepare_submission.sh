#!/bin/bash
# bash prepare_submission.sh /home/fdias/repositorios/media/experiments/train_submissao/logs/Normal/1stSubmission2024-03-21_09-40-52 /home/fdias/CHALLENGE_SUBMISSIONS
