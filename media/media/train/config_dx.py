...
'''Save
'''
name = 'first_submission_test'
save_dir = '/home/fdias/repositorios/media/logs'
save_model = True
save_script = False
timers = {}
...
'''
size = 224
data_img_dir = '/home/fdias/repositorios/media/data/ptbxl_noise'
resized_path = '/home/fdias/data/CINC_CHALLENGE_2024/GENERATED_IMAGE/PTB-XL/ALL/NOISE_224/more_img'
# resized_path = '/home/fdias/data/CINC_CHALLENGE_2024/GENERATED_IMAGE/PTB-XL/ALL/NOISE_384'
data_perc = 0.2
...
scheduler = None #lambda optimizer: torch.optim.lr_scheduler.StepLR(optimizer, step_size=5, gamma=0.1)
# lr_scheduler = lambda optimizer, len_loader: torch.optim.lr_scheduler.OneCycleLR(optimizer, 
#                                                    max_lr=lr, 
