...
BASE_DIR="/mnt/processed1/signals/datasets/CINC_2021_REMOVE_USELESS_DATASETS/training"
FULL_MODE_SAVE=$(echo "$FULL_MODE" | sed 's/,/_/g')
SAVE_DIR="/mnt/processed2/signals/cinc2021_image/documents/CINC_CHALLENGE_2024/GENERATED_IMG/CINC21/${COLUMNS}_${FULL_MODE_SAVE}"
...
#SBATCH --array=0-$((${#ALL_PATHS[@]} - 1))%200
